...
UNIT_TEST(array_tuple) {
	data::array_tuple<float, 2> a;
	UNIT_TEST_TRUE(true, "default constructible");
	data::array_tuple<float, 2> b(1, 2);
	...
	const data::array_tuple<int, 3> c(3, 4, 5);
	...
	const data::array_tuple<int, 4> d(6, 7, 8, 9);
	UNIT_TEST_TRUE(true, "four-element constructor");
	UNIT_TEST_TRUE((d == data::array_tuple<int, 4>(6, 7, 8, 9)), "equality test");
	UNIT_TEST_TRUE((d != data::array_tuple<int, 4>(6, 7, 9, 8)), "inequality test");
	data::array_tuple<int, 4> e(d);
	UNIT_TEST_TRUE(d == e, "copy constructor");
	data::array_tuple<char, 4> f;
	f.get<0>() = 'a';
